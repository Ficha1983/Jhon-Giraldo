...
import json  # Para manejar entradas de JSON de manera segura
...
def run(db):
    ...
    while True:
        ...
        if choice == "0":
            ...
            try:
                validator = json.loads(validator_input)  # Convertir cadena JSON a diccionario
            ...
            try:
                schema = json.loads(schema_input)  # Convertir cadena JSON a diccionario
                validation_level = console.input("Nivel de validación (strict/off) [strict]: ") or "strict"
                validation_action = console.input("Acción de validación (error/warn) [error]: ") or "error"
            ...
            if test_choice == "1":
                ...
                try:
                    doc = json.loads(doc_input)  # Convertir cadena JSON a diccionario
